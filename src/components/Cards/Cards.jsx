...
const Cards = () => {
  return (
    <div>
      ...
      <div className='flex justify-center gap-28 mt-8 lg:grid flex-wrap'>

        <div className="card w-80 dark:bg-base-100 dark:text-black bg-slate-800 text-white shadow-2xl" data-aos="fade-up">
